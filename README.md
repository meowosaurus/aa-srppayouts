# srppayouts Plugin App for Alliance Auth (GitHub Version)<a name="srppayouts-plugin-app-for-alliance-auth-github-version"></a>

This is an srppayouts plugin app for [Alliance Auth](https://gitlab.com/allianceauth/allianceauth)
...
_(These badges are srppayoutss, you can and should replace them with your own)_

For the GitLab version of this srppayouts app, please have a look over here, Erik
Kalkoken was so friendly to provide it » [Alliance Auth srppayouts App (GitLab Version)](https://gitlab.com/ErikKalkoken/allianceauth-srppayouts-plugin)

______________________________________________________________________

<!-- mdformat-toc start --slug=github --maxlevel=6 --minlevel=1 -->

- [srppayouts Plugin App for Alliance Auth (GitHub Version)](#srppayouts-plugin-app-for-alliance-auth-github-version)
  - [Features](#features)
...
To use this srppayouts as a basis for your own development, just fork this repo and then
...
```bash
git clone https://github.com/YourName/aa-srppayouts-plugin.git aa-your-app-name
cd aa-your-app-name
rm -rf .git
git init
pre-commit install
...
additional apps that might also be called srppayouts.

Here is an overview of the places that you need to edit to adopt the name.

Easiest is to just find & replace `srppayouts` with your new app name in all files
listed below.
...
| ---------------------------------------- | -------------------------------------------------------------------------------------- |
| `./srppayouts/`                             | Folder name                                                                            |
| `./srppayouts/static/srppayouts/`              | Folder name                                                                            |
| `./srppayouts/templates/srppayouts/`           | Folder name                                                                            |
| `./pyproject.cfg`                        | Update module name for version import, update package name, update title, author, etc. |
| `./srppayouts/apps.py`                      | App name                                                                               |
| `./srppayouts/__init__.py`                  | App name                                                                               |
| `./srppayouts/auth_hooks.py`                | Menu hook config incl. icon and label of your app's menu item appearing in the sidebar |
| `./srppayouts/models.py`                    | App name                                                                               |
| `./srppayouts/urls.py`                      | App name                                                                               |
| `./srppayouts/views.py`                     | Permission name and template path                                                      |
| `./srppayouts/templates/srppayouts/base.html`  | Title of your app to be shown in all views and as title in the browser tab             |
| `./srppayouts/templates/srppayouts/index.html` | Template path                                                                          |
